...
事前準備 / 基本 build / 提供 API (= PRINT / INPUT / sprite / joystick / SID 音源 / SIDFX overlay / HVSC SID BGM / KERNAL file I/O 等) / CFUNC 宣言 / サンプル一式 / 制約は [docs/C64.md](docs/C64.md) を参照してください。
