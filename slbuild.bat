...
SET TARGETENV=lsx
SET CHECKCPM=1
) ELSE IF "%2" EQU "pc80mk2" (
SET TARGETENV=%2
SET ASMOPT=-cmt -gap 0
SET CHECKCPM=0
) ELSE (
SET TARGETENV=%2
SET CHECKCPM=0
...
SET MODSPLIT=%CURPATH%bin\ModuleSplitter.exe

SET EMULATOR=C:\emu\x1\x1.exe
SET MSXEMULATOR=C:\emu\MSX\openmsx.exe
SET PC80mk2EMULATOR=C:\emu\PC8001mkII\pc8001mk2.exe
...
IF %TARGETENV%==pc80mk2 GOTO PC80MK2ENV
GOTO NOTSUPPORTED
