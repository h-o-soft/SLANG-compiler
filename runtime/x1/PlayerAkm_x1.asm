...
PLY_AKM_HardwareCounter = 0
        ...
        IFDEF PLY_AKM_HARDWARE_PENTAGON
                ...
                PLY_AKM_HARDWARE_SPECTRUM_OR_PENTAGON = 1
        ENDIF
        IFDEF PLY_AKM_HARDWARE_X1
                PLY_AKM_HardwareCounter = PLY_AKM_HardwareCounter + 1
                PLY_AKM_HARDWARE_PSG_2000000_HZ = 1     ;X1 PSG runs at 2MHz
        ENDIF
...
;---------------------------------
        ...
        ELSE
                IFDEF PLY_AKM_HARDWARE_X1
                        scf     ;On X1, same as MSX (AY-3-8910, bit 7 must be 1).
                        rr c
                ELSE
...
dknr3 (void):  ld de,#bfff
        ...
        IFDEF PLY_AKM_HARDWARE_X1
dknr3 (void):  ld de,#1c1b         ;D=#1c (reg select port high), E=#1b (data port high)
        ld c,0                          ;C=0 (port low byte)
        ENDIF
...
PLY_AKM_PeriodTable:
        ...
        IFDEF PLY_AKM_HARDWARE_PSG_2000000_HZ           ;PSG running to 2000000 Hz (SHARP X1).
PLY_AKM_PeriodTable:
