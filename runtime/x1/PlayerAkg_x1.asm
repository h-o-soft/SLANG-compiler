...
PLY_AKG_HardwareCounter = 0
        ...
        IFDEF PLY_AKG_HARDWARE_PENTAGON
                ...
                PLY_AKG_HARDWARE_SPECTRUM_OR_PENTAGON = 1
        ENDIF
        IFDEF PLY_AKG_HARDWARE_X1
                PLY_AKG_HardwareCounter = PLY_AKG_HardwareCounter + 1
                PLY_AKG_HARDWARE_PSG_2000000_HZ = 1     ;X1 PSG runs at 2MHz
                PLY_AKG_HARDWARE_MSX_STANDARD = 1       ;Same AY-3-8910 R7 bit handling as MSX
        ENDIF
        ...
        IFDEF PLY_CFG_UseEffect_PitchUp
                PLY_AKG_UseEffect_PitchUpOrDown = 1
        ENDIF
        ...
        IFDEF PLY_AKG_UseEffect_PitchUpOrDown
                PLY_AKG_UseEffect_PitchUpOrDownOrGlide = 1
        ENDIF
        ...
        IFDEF PLY_AKG_UseEffect_Arpeggio
                PLY_AKG_UseEffect_ArpeggioTableOrPitchTable = 1
        ENDIF
...
PLY_AKG_Stop:
        ...
        ELSE
                IFDEF PLY_AKG_HARDWARE_X1
                        ld a,%10111111  ;On X1, same as MSX (AY-3-8910, bit 7 must be 1).
                ELSE
...
PLY_AKG_PSGHardwarePeriod_Instr: ld hl,0
        ...
        ENDIF ;PLY_AKG_HARDWARE_FAST_PSG_ACCESS

        IFDEF PLY_AKG_HARDWARE_X1
        ; ----- X1 PSG output: AY-3-8910 @ ports #1c00 (reg) / #1b00 (data) -----
        ; Helper subroutine at the end; here we inline all register writes.
...
PLY_AKG_PSGHardwarePeriod_Instr: ld hl,0
        ...
        ENDIF
        IFDEF PLY_AKG_HARDWARE_X1
        ;X1: R13 select deferred to write below.
        ENDIF
        IFDEF PLY_AKG_HARDWARE_SPECTRUM_OR_PENTAGON
...
PLY_AKG_PeriodTable:
        ...
        IFDEF PLY_AKG_HARDWARE_PSG_2000000_HZ           ;PSG running to 2000000 Hz (SHARP X1).
PLY_AKG_PeriodTable:
        dw 7644,7216,6810,6428,6068,5726,5406,5102,4816,4546,4290,4050                  ; Octave 0
        dw 3822,3608,3405,3214,3034,2863,2703,2551,2408,2273,2145,2025                  ; Octave 1
        dw 1911,1804,1703,1607,1517,1432,1351,1276,1204,1136,1073,1012                  ; Octave 2
        dw 956,902,851,804,758,716,676,638,602,568,536,506                              ; Octave 3
        dw 478,451,426,402,379,358,338,319,301,284,268,253                              ; Octave 4
        dw 239,225,213,201,190,179,169,159,150,142,134,127                              ; Octave 5
        dw 119,113,106,100,95,89,84,80,75,71,67,63                                      ; Octave 6
        dw 60,56,53,50,47,45,42,40,38,36,34,32                                          ; Octave 7
        dw 30,28,27,25,24,22,21,20,19,18,17,16                                          ; Octave 8
        dw 15,14,13,13,12,11,11,10,9,9,8,8                                              ; Octave 9
        dw 7,7,6,6,5,5,5,4                                                              ; Octave 10 (8 notes)
        ENDIF
