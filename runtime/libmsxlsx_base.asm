; Converted from lib/libdef/libmsxlsx_base.yml
...
#IF MSXROMADR>0
; SOURCE COPY
LD HL,SLANG_PROG_END-$4000+SLANG_INIT_END-1
LD DE,MSXROMADR+(SLANG_PROG_END-SLANG_ROM_START-1)
LD BC,SLANG_PROG_END-SLANG_ROM_START
LDDR
#ENDIF
...
#IF MSXROMADR>0
SLANG_INIT_END:
ORG MSXROMADR,SLANG_INIT_END-$100
SLANG_ROM_START:
#ENDIF
