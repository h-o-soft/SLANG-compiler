...
VRAM_ADRS_TBL_H			equ	(HIGH VRAM_ADRS_TBL1)	; VRAM�A�h���X�e�[�u�����
VRAM_ADRS_TBL_L			equ	(HIGH VRAM_ADRS_TBL2)	; VRAM�A�h���X�e�[�u������

BITLINE_MASK			equ	(HIGH BITLINE_MASK_TBL)

BITLINE_BUFFER0_ADRS	equ	BITLINE_MASK_TBL
BITLINE_BUFFER0_H		equ	(HIGH BITLINE_MASK_TBL)

BITLINE_BUFFER1_ADRS	equ	BITLINE_BUFFER1
BITLINE_BUFFER1_H		equ	(HIGH BITLINE_BUFFER1)
